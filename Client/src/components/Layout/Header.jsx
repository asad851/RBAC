import {
  ...
  function Header() {
    ...
    return (
      <header className="h-20 fixed z-[999]  right-0  w-full top-0 box-border px-5 py-5 flex justify-between items-center border-b-2 bg-white border-gray-200">
        <div className="w-full flex gap-2 items-center text-xl text-[#502c65]">
